...
# self-training of UnionCut, named UnionSeg
import os
import torch
import torch.nn as nn
import sys
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'UnionCut'))
import vision_transformer as vits


class UnionSeg(nn.Module):
    def __init__(self,
                 vit_model="dino",
                 vit_arch="vit_small",
                 vit_patch_size=8,
                 enc_type_feats="k"):
        super(UnionSeg, self).__init__()
