...
if __name__ == "__main__":
    ...
    # initialize dataset
    dataset = UnionSegDataset("/home/wzl/DataSet/",
                              "/media/wzl/T7/PhysicalImageAugmentation/PseudoMaskGenration/DUTS/h5/TokenGraphCutN1_tao0.2_DUTS_Train_ViT_S_16_flexible_8_fixed.h5")
