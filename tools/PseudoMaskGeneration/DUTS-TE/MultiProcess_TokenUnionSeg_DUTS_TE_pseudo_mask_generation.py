...
def h5writer(result_queue, patch_size=16, resize_mode="flexible", UnionCut_patch_size=8, UnionCut_resize_mode="fixed"):
    # create the h5 file
    file = h5py.File("./h5/TokenUnionSegN1_tao0.2_DUTS_Test_ViT_S_" + str(patch_size) + "_" + resize_mode + "_" + str(UnionCut_patch_size) + "_" + UnionCut_resize_mode +".h5", "w")
...
if __name__ == "__main__":
    ...
    # default arguments
    parser.add_argument('--dataset', type=str, default="/home/wzl/DataSet/", help='root path of the DUTS-TE dataset')
    ...
    image_names = [image.split('.')[0] for image in os.listdir(root_path + "DUTS/DUTS-TE/DUTS-TE-Image/")]

    # save absolute paths of each image in the computer
    local_paths = [root_path + "DUTS/DUTS-TE/DUTS-TE-Image/" + image_name + ".jpg"
                   for image_name in image_names]
    # save relevant paths of each image under the dataset
    image_paths = ["DUTS/DUTS-TE/DUTS-TE-Image/" + image_name + ".jpg" for image_name in image_names]
