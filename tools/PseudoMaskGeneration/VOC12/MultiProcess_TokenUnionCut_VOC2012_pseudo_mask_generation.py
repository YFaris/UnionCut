...
def h5writer(result_queue, patch_size=16, resize_mode="flexible", UnionCut_patch_size=8, UnionCut_resize_mode="fixed"):
    # create the h5 file
    file = h5py.File("./h5/TokenUnionCutN1_tao0.2_VOC2012_Trainval_ViT_S_" + str(patch_size) + "_" + resize_mode + "_" + str(UnionCut_patch_size) + "_" + UnionCut_resize_mode +".h5", "w")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--process-num', type=int, default=28, help='the number of subprocesses launched for acceleration')
